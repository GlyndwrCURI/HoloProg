...
#define SIZ_SERIOUS_WARNS_TABLE 30
char SeriousWarningsStrings[SIZ_SERIOUS_WARNS_TABLE][46] = {//These are text descriptions (for the CPC to display) for status codes reported by the UC3 in it's status record
  ...
  "E4: PixSignal Stop (Fill_raArray)",
  "E5: Unrecognised Sub-Type on Type 1 mess",
  "E6: BAD UDP CHECKSUM",             //Error 6
  "E7: 1514 byte Packet, unrecog Type",
  "E8: Direction Table Full!",
  "E9: Pix Freq@1!!, Is Hologram Freq correct?",   //Error 9
  ...
  "E22: Pix Freq@2!!, Is Hologram Freq correct?",
  "E23: PixSignal is Stopped (CheatFill_raArray)",
  "E24: *ptrAccProfileCumulative != U32_TCs_2Go",
  "E25: AccProfile had a zero steps element!",
  "E26: PID motor got a type 1 MPOS data message",
//"E27: PIX Freq not 2 @ Cheated!",
//"E28: PIX Freq not 2 @ Fill_raArray!"
  "E27: TC too long for Constant Speed",
  "E28: Pulsing Interrupt - impossible!",
  "E29: TC too long 4 Homing Const Speed-HAPsOK?"
};
...
//The old attempt at this function, with mutex's (when the controls were in a dialogbox rather than the main Window) is now in \OldCode\Old UpdateMainWindowWithMutexs.cpp
int UpdateMainWindowsControlsM(void){ //returns zero if it Succeeds
 ...
 for(nchMotorNo = 0; nchMotorNo < NOOFMOTORS; nchMotorNo++)
   if(PCFrec.bMotor2ExpectRepliesFrom[nchMotorNo]){
      ...
      if(nReturnCodeFromSendPkts){
         ...
         MessageBox(hGLWnd,"Stopped 4 debugger (uncommon)!\n-unless AVRs are powered off","nReturnCodeFromSendPkts Error",MB_OK);
 ...
 //      nReturnCodeFromReceivePktsAr[nchMotorNo] = R eceiveMessagePackets(NULL, nchMotorNo, M sTyp2_ZENDstatREC, 0); //will have cleared this.
...
//int SecondAttemptAtReceiving = ReceiveMessagePackets(NULL, 0, M sTyp2_ZENDstatREC, 0);      // best to avoid MessageBoxes (hence use of NULLs)
